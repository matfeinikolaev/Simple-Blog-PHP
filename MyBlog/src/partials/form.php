...
<form method="POST" action="/post">
  ...
  <input class="form-control" id="text" name="text" type="text" placeholder="Type your text in here"><br>
  <button class="btn btn-lg btn-primary btn-block" type="submit">Post</button><br>
</form>